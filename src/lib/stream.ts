// TODO: This should be shared with a Wordware library
export type RecursiveDict<T> = {
  [key: string]: RecursiveDict<T> | T | RecursiveDict<T>[] | T[];
};

export type VariableType = string | number;

// TODO: Use a better type for variables e.g. something where source, update time, and datatype can be tracked
export type RuntimeVariables = RecursiveDict<VariableType>;
...
export type PromptOutput = {
  ...
  output: undefined | RuntimeVariables | string;
};
...
export type OutputType = ChunkOutput | GenerationOutput | PromptOutput | GenericOutputs | LoopOutput | CodeOutput;

export type JSONValueType = null | string | number | boolean | { [x: string]: JSONValueType } | Array<JSONValueType>;
// Copied from https://github.com/axflow/axflow/blob/main/packages/models/src/shared/stream.ts
/**
